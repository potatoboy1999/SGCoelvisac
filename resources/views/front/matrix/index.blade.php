  ...
  <body class="content">
    ...
    <section class="interna">
            ...
            <div class="accordion-item">
              ...
              <div id="menu1Body" class="accordion-collapse collapse show" aria-labelledby="menu1Head" data-bs-parent="#menuInterna">
                <div class="accordion-body">
                  ...
                  <a href="#">Finanzas</a>
                  <a href="#">Comercial</a>
                  <a class="active" href="#">Operaciones</a>
                  <a href="#">DDNN</a>
                  <a href="#">Legal</a>
      ...
      <section id="contenido">
        <div class="container-fluid">
          <div class="row">
            <div class="marco col-md-12 col-xs-12">
              <div class="box">
                <h2 class="titulo"><i class="fas fa-cog"></i>Matríz de Agenda de Gestión Estratégica &raquo; <span>Operaciones</span></h2>
                <div class="cuerpo">
                  <div class="buscador">
        ...
        <footer>
          Copyrignt &copy; Comercio Electrónico de Villacuri S.A.c. 2022
        </footer>
      </section>
